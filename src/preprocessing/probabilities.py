...
def class_prior(data: pd.DataFrame, pos_col: str, freq_col: str):
    """
    Class Prior Probability calculates the probability distribution of PoS tags/grammar types.

    Args:
        data: DataFrame of data.
        pos_col: Name of the `data` column to access PoS tags.
        freq_col: Name of the `data` column to access frequencies.

    Returns:
        DataFrame: Percentages, divided into PoS column and its probability
        Tuple: Matplotlib (fig, ax) tuple of objects for visualizing results
    """
...
def hamilton(percentages: pd.DataFrame, limit: int):
    ...
    Args:
        percentages: Percentages DataFrame generated by `class_prior` with PoS tags and its respective probabilities.
        limit: Discrete limit of amount of words to distribute. Equals the size of the final flashcard set.

    Returns:
       DataFrame: Discrete amounts, divided into PoS column and its discrete probability based on `limit`
       Tuple: Matplotlib (fig, ax) tuple of objects for visualizing results
